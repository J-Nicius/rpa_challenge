from funcoes.utils import resource_path, copiar_arquivo_para_dados
from funcoes.leitor_planilha import (
    ler_dados_planilha,
    imprimir_dados,
    selecionar_arquivo_excel,
)
...
def main():
    ...
    caminho_driver = resource_path("drivers/chromedriver.exe")
    ...
    if not caminho_original_planilha:
        ...
        if not caminho_final_planilha:
            ...
            if dados is not None:
                ...
                navegador = abrir_navegador_e_site(
                    "https://rpachallenge.com/", caminho_driver
                )
